...
# load all data
data = pd.read_csv('data/music-eeg-features.csv')


data = data.drop(columns=['subject no.'])
...
Here we build a neural network with one hidden layer.
    input layer: 25 neurons, representing the features of EEG
    hidden layer: 30 neurons, using Sigmoid as activation function
    output layer: 3 neurons, representing the music genre
"""
